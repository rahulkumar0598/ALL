    ...
    public static class ExtensionUnitOfWorkService
    {
		...
		public static void RegisterRepositories(this IServiceCollection service)
        {
           ...
           // service.AddSingleton<IProductUnitOfWork, ProductUnitOfWork>();
            service.AddSingleton<IEventRepository, EventRepository>();
            service.AddSingleton<ISignUpUserRepository, SignUpUserRepository>();
            service.AddSingleton<ILoginUserRepository, LoginUserRepository>();
        }
    }
}
